...
Well, most of them have arrived, but I'm missing just one... #speaker: Daisuke #trigger: next
...
Hmm, I'm not too sure about this... #speaker: Daisuke #trigger: next
...
=== Submit === 
You have the fish? #speaker: Daisuke #trigger: Submit
    +[Yes! Check it out!]
    ~ SubmitQuest()
    ->SumbitCheck
...
Well that's the rate we usually charge people for special requests! #speaker: Daisuke #trigger: next
...
=== GenericExit ===
Hmmm.... #speaker: Daisuke #trigger: exit
->END